...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Filter::factory()->create(['name' => 'Filter 1']);
        Filter::factory()->create(['name' => 'Filter 2']);
        Filter::factory()->create(['name' => 'Filter 3']);
        Filter::factory()->create(['name' => 'Filter 4']);
