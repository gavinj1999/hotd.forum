   ...
   <div>
    ...
    <span class="ml-2">All ideas</span>
                ...
                <div class="w-full mx-4">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <span class="mr-1">Set Status</span>    <svg class="text-gray-600 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="buttons-container flex items-center justify-between mt-6">
            <button type="button" class="flex items-center w-32 justify-center h-11 text-xs bg-blue text-white font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3">                
