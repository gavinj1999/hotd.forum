        ...
        <main class="container mx-auto flex" style="max-width:1000px;">
          ...
          <div class="bg-white border-2 border-blue rounded-xl mt-16">
            ...
            <form action="" method="POST" class="space-y-4 px-4 py-6">
                ...
                <div>
                    <textarea name="idea" id="idea" cols="30" rows="4" class="w-gull bg-gray-100 rounded-xl placeholder-gray-900 text-sm px-4 py-2" placeholder="Describe your idea"></textarea>
                </div>
            </form>
        </div>
            </div>
