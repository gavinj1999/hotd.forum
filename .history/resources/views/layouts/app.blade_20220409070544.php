...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
            ...
            <form action="" method="POST" class="space-y-4 px-4 py-6">
                ...
                <div class="flex items-center justify-between space-x-3">
                    <button type="button" class="flex items-center justify-center w-1/2 h-11 text-xs bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3">                
                      ...
                      <button type="submit" class="flex items-center justify-center w-1/2 h-11 text-xs bg-blue text-white font-semibold rounded-xl border border-blue hover:border-blue transition duration-150 ease-in px-6 py-3">                
        ...
        <div class="w-24">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eius quo autem, dolores saepe est dolor libero alias. Magni veritatis, blanditiis, id, corrupti sequi sapiente pariatur illum cupiditate quae cumque non magnam! Alias assumenda laudantium quisquam fugiat ad iusto, ratione neque, vero architecto aspernatur perspiciatis consequatur impedit distinctio adipisci molestiae voluptate exercitationem, maiores tenetur magni provident? Sunt numquam cum nam libero. Qui commodi eius laborum ut tempora beatae eos nesciunt tenetur harum exercitationem modi totam nostrum vitae, ipsum voluptatibus, officiis eligendi vero voluptate, quibusdam asperiores est nihil. Nesciunt et quis similique quaerat ratione quas, facilis adipisci ad pariatur, fuga repellat?
        </div>
        </main>
    </body>
</html>
