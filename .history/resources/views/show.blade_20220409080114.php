    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        <div class="flex items-center space-x-4 ml-6">
            ...
            <div class="absolute z-10 w-104 text-left font-semibold text-sm bg-white shadow-dialog rounded-xl mt-2">
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quis ducimus natus, pariatur molestiae quos hic assumenda quae aperiam eos sint sapiente at nesciunt atque debitis delectus officia obcaecati corrupti suscipit!
            </div>
            </div>
